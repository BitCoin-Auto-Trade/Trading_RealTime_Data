"""개선된 WebSocket 연결 관리 (Auto Reconnection)"""
...
class WebSocketConnectorV2:
    """
    개선된 바이낸스 선물 WebSocket 연결 관리
    ...
    def __init__(
        ...
        self.streams = streams or {"depth", "aggTrade"}
        self.logger = setup_logger("websocket_v2")
